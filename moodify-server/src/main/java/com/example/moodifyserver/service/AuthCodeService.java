...
//          .state("x4xkmn9pu3j6ukrs8n")
            .scope("user-read-private,user-read-email,user-top-read,user-modify-playback-state,streaming,user-read-currently-playing,playlist-modify-public,playlist-modify-private")
            .show_dialog(true)
            .build();
